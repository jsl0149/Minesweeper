...
class Level2 extends JFrame{
    ...
    int endCount                 = 0; //지뢰를 제외한 타일이 몇개 오픈됐는지 카운트 (타일-지뢰수)가 되면 게임종료
	...
	final int SIZE_OF_PANEL_GARO = 20; //지뢰판 크기 설정
	final int SIZE_OF_PANEL_SERO = 10; // 지뢰판 크기 설정
	final int NUM_OF_MINE        = 35;
	final int OPEN               = 2;
...
public void saveGame() {
	...
	String mine = "E:\\Temp\\mineRoomLv2.txt";
	String open = "E:\\Temp\\openCheckLv2.txt";
	String click = "E:\\Temp\\clickCheckLv2.txt";
	String timerPath = "E:\\Temp\\timerLv2.txt";
